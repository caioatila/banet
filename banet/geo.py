...
# %% auto 0
__all__ = ['Region', 'open_shp', 'open_tif', 'bounds_from_shapefile', 'size_from_bounds', 'size_resolution_assert', 'rasterize',
           'downsample', 'is_intersection', 'polygon_from_bounds', 'crop', 'bounds_from_coords']
