# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_geo.ipynb.

# %% auto 0
__all__ = ['Region', 'calculate_resolution', 'open_shp', 'open_tif', 'bounds_from_shapefile', 'size_from_bounds',
           'size_resolution_assert', 'rasterize', 'downsample', 'is_intersection', 'polygon_from_bounds', 'crop',
           'bounds_from_coords']
...
# %% ../nbs/01_geo.ipynb 5
def calculate_resolution(distance_m):
    """Rough conversion from spatial resolution in meters to degree"""
    degrees_per_meter = 1 / (111.32 * 1000)
    getcontext().prec = 6
    return Decimal(distance_m * degrees_per_meter)
